...
void Sparsifier::DoMarginalizeSE3XYZ(const vector<g2o::SE3Quat> vKF, const vector<g2o::Vector3d> vMP,
...
//    idxKF1 = 0; idxKF2 = 1;
    ...
    for (int i=0; i<vMeasureRelated.size(); i++) {
...
//        }
    ...
    H.block(0,0,6,6) += Eigen::MatrixXd::Identity(6, 6) * 1e-6;
                       ...
                       Eigen::Matrix<double, 6, 6> & info)
{
    ...
    info = (J * H.inverse() * J.transpose()).inverse();
}
